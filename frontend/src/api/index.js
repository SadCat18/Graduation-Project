...
export const api = {
  ...
  activityDetail: (id) => http.get(`/api/public/activities/${id}`),
  ...
  adminPostDetail: (id) => http.get(`/api/admin/posts/${id}/detail`),
  adminDeletePost: (id) => http.delete(`/api/admin/posts/${id}`),
  adminTopPost: (id, top) => http.put(`/api/admin/posts/${id}/top`, null, { params: { top } }),
  adminBatchDeletePosts: (data) => http.post('/api/admin/posts/batch-delete', data),
  adminBatchTopPosts: (data) => http.post('/api/admin/posts/batch-top', data),
  adminComments: (params) => http.get('/api/admin/comments', { params }),
  adminCommentContext: (id) => http.get(`/api/admin/comments/${id}/context`),
  adminDeleteComment: (id) => http.delete(`/api/admin/comments/${id}`),
  adminBatchDeleteComments: (data) => http.post('/api/admin/comments/batch-delete', data),
  ...
  adminNewsDetail: (id) => http.get(`/api/admin/news/${id}`),
  adminCreateNews: (data) => http.post('/api/admin/news', data),
  adminSyncNews: () => http.post('/api/admin/news/sync'),
  adminSyncNewsAi: () => http.post('/api/admin/news/ai-sync'),
  adminSyncNewsStatus: () => http.get('/api/admin/news/sync-status'),
  adminSyncNewsNow: (data) => http.post('/api/admin/news/sync-now', data, { timeout: 180000 }),
  adminUpdateNews: (id, data) => http.put(`/api/admin/news/${id}`, data),
  adminReviewNews: (id, data) => http.put(`/api/admin/news/${id}/review`, data),
  adminReprocessNewsAi: (id) => http.post(`/api/admin/news/${id}/ai-reprocess`),
  adminNewsConfigCheck: () => http.get('/api/admin/ai/news-config-check'),
  adminNewsAiPreview: (data) => http.post('/api/admin/news/ai-preview', data, { timeout: AI_REQUEST_TIMEOUT }),
